        ...
        try:
            ...
            for method in default_methods:
                user_payment_objects.append(
                    PaymentMethod(user_id=user_save, payment_method=method)
                )

            PaymentMethod.objects.bulk_create(user_payment_objects) # bulk_create() → sabhi entries ko ek hi baar mein save kar diya (zyada fast & efficient).
